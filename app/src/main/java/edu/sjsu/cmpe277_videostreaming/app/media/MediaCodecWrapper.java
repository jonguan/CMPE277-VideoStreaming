...
package edu.sjsu.cmpe277_videostreaming.app.media;
...
public class MediaCodecWrapper {
    ...
    /**
     * The {@link android.media.MediaCodec} that is managed by this class.
     */
     ...
     * {@link android.media.MediaFormat} object.
     *
     ...
     *
     * @param flags Flags to pass to the decoder. See {@link android.media.MediaCodec#queueInputBuffer(int,
     * int, int, long, int)}
     *
     ...
     * java.nio.ByteBuffer)}
     *
     * @param render True, if the buffer is to be rendered on the {@link android.view.Surface} configured
     *
     */
